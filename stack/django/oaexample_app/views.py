...
from .permissions import can_view_actionplans, can_add_users, can_view_rooms, can_view_resources, can_view_officials, can_edit_rooms, can_edit_resources, can_view_cities, can_view_meetings, can_delete_invites, can_view_invites, can_add_rooms, can_add_cities, can_edit_cities, can_view_rallies, can_edit_actionplans, can_delete_cities, can_add_invites, can_delete_rallies, can_add_rallies, can_view_profile_users, can_edit_invites, can_delete_rooms, can_add_resources, can_add_actionplans, can_delete_resources, can_add_meetings, can_edit_officials, can_delete_subscriptions, can_view_subscriptions, can_add_officials, can_delete_officials, can_delete_meetings, can_view_list_users, can_edit_rallies, can_edit_meetings, can_add_subscriptions, can_delete_actionplans, can_edit_subscriptions, can_view_list_resources
