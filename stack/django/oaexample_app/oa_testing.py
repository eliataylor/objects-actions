...
@extend_schema_view(
    ...
    update=extend_schema(description="Update an existing 'oa-tester' user."),
    partial_update=extend_schema(description="Partially update an existing 'oa-tester' user."),
    destroy=extend_schema(description="Delete a specific 'oa-tester' user by ID.")
)
