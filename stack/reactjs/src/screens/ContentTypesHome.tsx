...
const ContentTypesHome: React.FC<ContentTypesHomeProps> = ({ loading = undefined }) => {
  ...
  return <React.Fragment>
    ...
    <Typography variant={"body2"} sx={{marginTop:4}} gutterBottom={true}>These content types and their forms were generated by following <Link to={"/oa/customize"}>this tutorial</Link></Typography>
  </React.Fragment>;
};
