...
const ObjectActionsContext = createContext<
  ObjectActionsContextProps | undefined
>(undefined);
...
const ObjectActionsProvider: React.FC<ObjectActionsProviderProps> = ({
  children,
}) => {
...
export const useObjectActions = (): ObjectActionsContextProps => {
  ...
  if (!context) {
    throw new Error(
      'useObjectActions must be used within a ObjectActionsProvider',
    );
  }
  return context;
};
