    ...
    return <Grid container spacing={1}>
        ...
        <Grid item xs={12} sm={6}>
            <Card variant="outlined">
                ...
                <Grid sx={{p: 1}} container justifyContent={'space-between'}>
                    <a href={'https://docs.google.com/spreadsheets/d/14Ej7lu4g3i85BWJdHbi4JK2jM2xS5uDSgfzm3rIhx4o/edit?gid=845262387#gid=845262387'}
                       target={'_blank'}>
                        <TightButton size={'small'}
                                     startIcon={<img src={'/oa-assets/Google_Sheets_2020_Logo.svg'}
                                                     height={20}/>}>New Worksheet</TightButton>
                    </a>
                    ...
                    <a
                        ...
                        <TightButton size={'small'}
                                     startIcon={<img src={'/oa-assets/Google_Sheets_2020_Logo.svg'}
                                                     height={20}/>}>Site Sample</TightButton>
                    </a>
                </Grid>
            </Card>
        </Grid>
        ...
        <Grid item xs={12} sm={6}>
            <Card>
                ...
                <Grid sx={{p: 1}} container justifyContent={'space-between'}>
                    <a href={'https://docs.google.com/spreadsheets/d/14Ej7lu4g3i85BWJdHbi4JK2jM2xS5uDSgfzm3rIhx4o/edit?gid=1619189607#gid=1619189607'}
                       target={'_blank'}>
                        <TightButton size={'small'}
                                     startIcon={<img src={'/oa-assets/Google_Sheets_2020_Logo.svg'}
                                                     height={20}/>}>New Worksheet</TightButton>
