...
const defaultEnvConfig: EnvConfig = {
  ...
  STACK_PATH: '.',
  TYPES_PATH: process.env.TYPES_PATH || 'src/examples/object-fields-demo.csv',
  PERMISSIONS_PATH: process.env.PERMISSIONS_PATH || 'src/examples/permissions-matrix-demo.csv',
  ...
  DEFAULT_PERMS: process.env.DEFAULT_PERMS || 'IsAuthenticatedOrReadOnly',
  OA_ENV_DB: process.env.OA_ENV_DB || 'docker',
  OA_ENV_EMAIL: process.env.OA_ENV_EMAIL || 'console',
  OA_ENV_STORAGE: process.env.OA_ENV_STORAGE || 'local',
};
